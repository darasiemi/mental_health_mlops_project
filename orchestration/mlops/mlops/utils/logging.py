...
DEFAULT_DEVELOPER = os.getenv('EXPERIMENTS_DEVELOPER', 'Dara')
TRACKING_SERVER_HOST = "ec2-13-48-28-240.eu-north-1.compute.amazonaws.com" # fill in with the public DNS of the EC2 instance
# mlflow.set_tracking_uri(f"http://{TRACKING_SERVER_HOST}:5000")
DEFAULT_EXPERIMENT_NAME = 'project-experiment-tracking'
DEFAULT_TRACKING_URI = f'http://{TRACKING_SERVER_HOST}:5000'
