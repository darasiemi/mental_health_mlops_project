...
def train_model(
    ...
    eval_metric: Callable = accuracy_score,
    ...
    **kwargs,
    ...
    if X_val is not None and y_val is not None:
        ...
        accuracy = eval_metric(y_val, y_pred)
...
def tune_hyperparameters(
    ...
    eval_metric: Callable[[Series, Series], float] = accuracy_score,
    fit_params: Optional[Dict] = None,
    ...
    def __objective(
        ...
        return dict(loss=metrics['accuracy'], status=STATUS_OK)
